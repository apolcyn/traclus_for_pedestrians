...
class TestTrajectoryLineSegments(unittest.TestCase):
    ...
    def test_creation(self):
        self.assertRaises((Exception, ArgumentError), traclus_dbscan.TrajectoryLineSegment, \
                          LineSegment.from_points([Point(0, 0), Point(1, 1)]), -1)
        self.assertRaises((Exception, ArgumentError), traclus_dbscan.TrajectoryLineSegment, None, 1)
        self.assertRaises((Exception, ArgumentError), traclus_dbscan.TrajectoryLineSegment, \
